...
{
    doForNodeParamIndexes (node->getIndex(), [=] (int forwardIndex) { forwardedParams[forwardIndex]->setParam (nullptr); });
...
{
    doForNodeParamIndexes (oldIndex, [=] (int forwardIndex) { forwardedParams[forwardIndex]->setParam (nullptr); });
